public class main {
	...
	public static void main(String[] args) {
		...
		usuario1.nome="Fernando";
		usuario1.login="fernando19";
		usuario1.senha="abc123";
		
		Livro livro1 = new Livro();
		
		livro1.titulo="Diario de um Banana";
		livro1.autor="Jeff Kinney";
		livro1.ano="2007";
		
		Biblioteca biblioteca1 = new Biblioteca(); 
		
		biblioteca1.nome="Biblioteca Municipal Rui Barbosa";
		biblioteca1.endereco="Arroio dos Ratos";
		biblioteca1.n_livros=578;
